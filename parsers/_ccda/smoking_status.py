...
def smoking_status(ccda):
    ...
    smoking_status_ = social_history.template('2.16.840.1.113883.10.20.22.4.78')
    if smoking_status_.is_empty():
        smoking_status_ = social_history.template('2.16.840.1.113883.10.22.4.78')

#    if not smoking_status_.is_empty():
